const questions = [
  ...
  },
  {
    ...
    options: ["stringify()", "parse()", "convert()", "JSONify()"],
  },
  {
    id: 6,
  ...
  },
  {
    id: 10,
    question:
      "Which of the following is the correct way to check if a variable 'a' is not equal to 10?",
    options: ["if(a != 10)", "if(a !== 10)", "if(a <> 10)", "Both 1 and 2"],
  },
];

const answers = [0, 3, 2, 1, 0, 0, 2, 3, 0, 3];
